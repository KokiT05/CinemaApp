        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReleaseDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2026, 4, 13, 19, 44, 54, 906, DateTimeKind.Local).AddTicks(2599), comment: "Movie Release Date"),
                    Director = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, comment: "Movie Director"),
                    Duration = table.Column<int>(type: "int", maxLength: 300, nullable: false, comment: "Movie Duration"),
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false, comment: "Movie IsDeleted")
                },
                constraints: table =>
                {
